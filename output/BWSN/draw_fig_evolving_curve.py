...
def drawAverReduced():
    funcid = 'Kulldorff'
    averOurMethod_IHT = get_funcValues('graph_IHT_BWSN_Result.txt', funcid)
    averOurMethod_IHTP = get_funcValues('graph_GHTP_BWSN_Result.txt', funcid)
    averFusedLasso_0_25 = get_funcValues('genFusedLasso_BWSN_Result_0.25_.txt',funcid)
    averFusedLasso_1_0 = get_funcValues('genFusedLasso_BWSN_Result_1.0_.txt',funcid)
    averFusedLasso_5_0 = get_funcValues('genFusedLasso_BWSN_Result_5.0_.txt',funcid)
    averFusedLasso_10_0 = get_funcValues('genFusedLasso_BWSN_Result_10.0_.txt',funcid)
    ...
    marker_fusedLasso_1_0, = plt.plot(x_, averFusedLasso_1_0, markers[2], markersize=10, label= 'Fused Lasso(1.0)',
             markerfacecolor = 'white',markeredgecolor='g',markeredgewidth=3.0)
    lin_fusedLasso_1_0, = plt.plot(x_, averFusedLasso_1_0, linestyle = '-',color = 'g',linewidth = 2.0, label= 'Fused Lasso(1.0)')
    #--------------------------------------------------------------------------------------------------------
    marker_fusedLasso_5_0, = plt.plot(x_, averFusedLasso_5_0, markers[3], markersize=10, label= 'Fused Lasso(5.0)',
             markerfacecolor = 'white',markeredgecolor='c',markeredgewidth=3.0)
    lin_fusedLasso_5_0, = plt.plot(x_, averFusedLasso_5_0, linestyle = '-',color = 'c',linewidth = 2.0, label= 'Fused Lasso(5.0)')
    #--------------------------------------------------------------------------------------------------------
    ...
    legend = plt.legend( [(marker_fusedLasso_0_25,lin_fusedLasso_0_25),
                        ...
                        loc='center right', shadow=True,prop={'size':14})
